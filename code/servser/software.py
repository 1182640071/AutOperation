...
def returnSoftwareHtml(request):
    ...
    :return:html
    '''
    from AutOperation.settings import softwareList
    return render(request, 'server/software.html' ,{'softwareList':softwareList})
...
def dealSoftware(request):
    ...
    print dicUser
    return HttpResponse(json.dumps(str(dicUser)), content_type="application/json")
